...
import (
	...
	"github.com/tenderly/net-optimism/accounts/abi/bind/backends"
	"github.com/tenderly/net-optimism/accounts/abi/bind/v2"
	"github.com/tenderly/net-optimism/accounts/abi/bind/v2/internal/contracts/events"
	"github.com/tenderly/net-optimism/accounts/abi/bind/v2/internal/contracts/nested_libraries"
	"github.com/tenderly/net-optimism/accounts/abi/bind/v2/internal/contracts/solc_errors"
