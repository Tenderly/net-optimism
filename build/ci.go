...
import (
	...
	"github.com/tenderly/net-optimism/crypto/signify"
	"github.com/tenderly/net-optimism/internal/build"
	"github.com/tenderly/net-optimism/internal/download"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/tenderly/net-optimism/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/tenderly/net-optimism/internal/version.gitDate="+env.Date)
	}
	if env.Tag != "" {
		ld = append(ld, "-X", "github.com/tenderly/net-optimism/version.gitTag="+env.Tag)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/tenderly/net-optimism/core/rawdb", "github.com/tenderly/net-optimism/ethdb/leveldb"},
		{"github.com/tenderly/net-optimism/core/rawdb", "github.com/tenderly/net-optimism/ethdb/pebbledb"},
	}
	tc := new(build.GoToolchain)
