...
coverpkg="github.com/tenderly/net-optimism/..."
...
repo=$GOPATH/src/github.com/tenderly/net-optimism
compile_fuzzer github.com/tenderly/net-optimism/accounts/abi \
  FuzzABI fuzzAbi \
  $repo/accounts/abi/abifuzzer_test.go

compile_fuzzer github.com/tenderly/net-optimism/common/bitutil \
...
compile_fuzzer github.com/tenderly/net-optimism/core/vm/runtime \
  FuzzVmRuntime fuzzVmRuntime\
  $repo/core/vm/runtime/runtime_fuzz_test.go

compile_fuzzer github.com/tenderly/net-optimism/core/vm \
  FuzzPrecompiledContracts fuzzPrecompiledContracts\
  $repo/core/vm/contracts_fuzz_test.go,$repo/core/vm/contracts_test.go

compile_fuzzer github.com/tenderly/net-optimism/core/types \
  FuzzRLP fuzzRlp \
  $repo/core/types/rlp_fuzzer_test.go

compile_fuzzer github.com/tenderly/net-optimism/crypto/blake2b \
  Fuzz fuzzBlake2b \
  $repo/crypto/blake2b/blake2b_f_fuzz_test.go

compile_fuzzer github.com/tenderly/net-optimism/accounts/keystore \
  FuzzPassword fuzzKeystore \
  $repo/accounts/keystore/keystore_fuzzing_test.go

pkg=$repo/trie/
compile_fuzzer github.com/tenderly/net-optimism/trie \
  FuzzTrie fuzzTrie \
...
compile_fuzzer github.com/tenderly/net-optimism/eth/protocols/snap \
...
compile_fuzzer github.com/tenderly/net-optimism/tests/fuzzers/bn256 \
...
compile_fuzzer github.com/tenderly/net-optimism/tests/fuzzers/txfetcher \
  Fuzz fuzzTxfetcher \
  $repo/tests/fuzzers/txfetcher/txfetcher_test.go

compile_fuzzer github.com/tenderly/net-optimism/tests/fuzzers/bls12381 \
...
compile_fuzzer github.com/tenderly/net-optimism/tests/fuzzers/secp256k1 \
  Fuzz fuzzSecp256k1\
  $repo/tests/fuzzers/secp256k1/secp_test.go

compile_fuzzer github.com/tenderly/net-optimism/eth/protocols/eth \
